                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                                          <form action="{{route('group.store')}}" method="POST">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="group_name" class="form-control" id="basicInput">
                                              </fieldset>

                                              <fieldset class="form-group">
                                                <label for="basicInput">Deskripsi Group</label>
                                                <input type="text" name="desc" class="form-control" id="basicInput">
                                              </fieldset>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <select class="select2 form-control" multiple="multiple" name="anggota[]">
